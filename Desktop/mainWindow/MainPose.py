...
from win3_1_ui import Ui_MainWindow as Win3_ui
from win4_1_ui import Ui_MainWindow as Win4_ui
...
if __name__ == "__main__":
    ...
    win1_1.pushButton_2.clicked.connect(
        lambda: {win1.close(), win1_1.close(), win3_1.show()}
    )
    # 第3畫面換第2畫面
    ...
    win1_2.pushButton_2.clicked.connect(
        lambda: {win1_1.close(), win1_2.close(), win1.close(), win3_1.show()}
    )
    # 第3畫面換第2畫面
    ...
    win1_3.pushButton_2.clicked.connect(
        lambda: {win1_1.close(), win1_2.close(), win1.close(), win1_3.close(), win3_1.show()}
    )
    #1_4
    win1_4 = Win1_4ui()
    #1-4 首頁換第2畫面
    ...
    win1_4.pushButton_2.clicked.connect(
        lambda: {win1_1.close(), win1_2.close(), win1.close(), win1_3.close(), win1_4.close(),  win3_1.show()}
    )
    #1_5
    win1_5 = Win1_5ui()
    #1-5首頁換第2畫面
    ...
    win1_5.pushButton_2.clicked.connect(
        lambda: {win1_1.close(), win1_2.close(), win1.close(), win1_3.close(), win1_4.close(), win1_5.close(), win3_1.show()}
    )
    #1_6
    win2 = Win2ui()
    #1-6 首頁換第2畫面
    ...
    win1_7.pushButton_2.clicked.connect(
        lambda: {win1_1.close(), win1_2.close(), win1.close(), win1_3.close(), win1_4.close(), win1_5.close(),
                 win2.close(), win1_7.close(), win3_1.show()}
    )
    #1_8
    win1_8 = Win1_8ui()
    #1-8 首頁換第2畫面
    ...
    win1_8.pushButton_2.clicked.connect(
        lambda: {win1_1.close(), win1_2.close(), win1.close(), win1_3.close(), win1_4.close(), win1_5.close(),
                 win2.close(), win1_7.close(), win1_8.close(), win3_1.show()}
    )
   ...
   # win3.pushButton_3.clicked.connect(
    ...
    # 第3畫面換第4畫面
    win4_1 = Win4ui()
    win3_1.pushButton_2.clicked.connect(
        lambda: {win1.close(), win2.close(), win3_1.close(), win4_1.show()}
    )

    # 第4畫面換第2畫面
    #win4_1.pushButton_3.clicked.connect(
     #   lambda: {win1.close(), win3_1.close(), win4_1.close(), win2.show()}
    #)

    # 第4畫面換第1畫面
    win4_1.pushButton_2.clicked.connect(
        lambda: {win2.close(), win3_1.close(), win4_1.close(), win1.show()}
    )
